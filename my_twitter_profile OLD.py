...
headers = {
	"X-RapidAPI-Key": "7536e40bc7msh24b14478c48f52cp16ca8ajsn2582d7657975",
...
def chiamata_api():
    ...
    followers = requests.get(url_followers, headers=headers, params=querystring)

    
    # scrivo i followers nel file di testo
    ...
    following = requests.get(url_following, headers=headers, params=querystring)
...
decisione = input('Effettuare una chiamata api per aggiornare i dati del profilo in realtime? (y/n) ').lower()
